...
ALLOWED_HOSTS = ['*']  # tighten this before deploying publicly
...
DATABASES = {
    'default': dj_database_url.config(
        default=(
            ...
            f"{os.environ.get('DB_NAME', 'school_portal')}"
        ),
        conn_max_age=600,
    )
}
...
# Dev-only: allows your Flutter app (running on a phone/emulator) to call the API freely.
